...
public class Exercises_frag extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        tricep.add(new Exercise_Item(R.drawable.benchpress1,R.drawable.benchpress2, "Chest Press", "Lie face up on a flat bench, and grip a barbell with the hands slightly wider than shoulder-width. Press the feet into the ground and the hips into the bench while lifting the bar off the rack. Slowly lower the bar to the chest by allowing the elbows to bend out to the side. Stop when the elbows are just below the bench, and press feet into the floor to press the weight straight up to return to the starting position."));
        ...
        back.add(new Exercise_Item(R.drawable.shoulder_packing1,R.drawable.shoulder_packing2, "Shoulder Packing", "Step 1: Starting Position: Stand with your feet hip-width apart, toes pointing forward, with arms by your sides. Contract your abdominal muscles (“brace”) to stabilize your spine while holding your chest up and out with your head tilted slightly up. "));
        ...
        back.add(new Exercise_Item(R.drawable.romanian_deadlift1,R.drawable.romanian_deadlift2, "Romanian Deadlift", "Holding a barbell with both hands so that it rests on the front of the thighs, keep a slight bend in both knees and a straight back. Push the hips back while lowering the weight towards the floor until feeling some tension along the back of the legs. To return to standing, push the heels into the floor and pull the knees backwards, keeping the bar very close to the body while standing."));
        //shoulders
        ...
        shoulders.add(new Exercise_Item(R.drawable.standing_shoulder_press1,R.drawable.standing_shoulder_press2, "Standing Shoulder Press", "Place a barbell in a rack at about shoulder-height. Grip the bar with the hands about shoulder-width apart and the palm facing the ceiling. Dip under the bar to bring it off the rack letting it rest across the top of the shoulders so that the palms are facing the ceiling and the elbows are pointed straight ahead. Step back, keeping the back straight and tall and press the barbell directly overhead. Slowly return the weight to the shoulders and repeat for the desired number of reps."));
        shoulders.add(new Exercise_Item(R.drawable.diagonal_raise1,R.drawable.diagonal_raise2, "Diagonal Raise", "Stand with the feet hip-width apart, hold one dumbbell in the left hand with the left arm down straight and the left palm resting in front of the right thigh. Press the feet into the ground, keep the hips straight and the back tall. Raise the left arm across the body and out to the left side so that the weight is brought up to shoulder-height and the arm is kept straight."));
        ...
        core.add(new Exercise_Item(R.drawable.decline_plank1,R.drawable.decline_plank2, "Decline Plank", "With the feet close together on top of the BOSU dome, place the elbows on the ground underneath the shoulders with the hands in fists. Squeeze the muscles of the stomach and glute, and keep the body in a straight line from head to heels. Hold this position for the desired amount of time."));
        core.add(new Exercise_Item(R.drawable.pull_over_crunch1,R.drawable.pull_over_crunch2, "Pull-over Crunch", "Lie face up flat on the ground with the feet flat on the floor and the knees bent up in the air. Place a kettlebell on the ground over the head, reach overhead with both hands, and grip the kettlebell by the handles. While keeping the arms straight, pull the kettlebell over the head to directly above the chest. Hold the kettlebell over the chest and draw the belly button in towards the ground to help pull the rib cage towards the hips, lifting the back off the ground to perform a crunch. Lower slowly back to the floor, and once the back is flat on the ground lower the kettlebell back overhead."));
        ...
        //glutes
        glutes.add(new Exercise_Item(R.drawable.elevated_glute_bridge1,R.drawable.elevated_glute_bridge2, "Elevated Glute Bridge", "Lie on a flat bench so that the body is perpendicular to the bench with the upper back and shoulders lying across the pad. Press the feet into the ground about hip-width apart, hold one dumbbell in each hand and rest them on top of the hips to add external resistance. Slowly lower the tailbone towards the floor while holding the weights on the hips, and to return to the top press both feet into the floor and squeeze the glute muscles."));
        glutes.add(new Exercise_Item(R.drawable.glute_press1,R.drawable.glute_press2, "Glute Press", "Adjust the pad to the proper height. Grasp the handles with elbows in a straight line with the hands and under the shoulders. Set the weight to the appropriate level before beginning. With the knees on the lower pad, place one foot on the rear platform. Press the foot into the platform and straighten the leg. Slowly return to the starting positing. Repeat for the desired number of reps before switching feet."));

        // upper_legs
        upper_legs.add(new Exercise_Item(R.drawable.back_squat1,R.drawable.back_squat2, "Back Squat", "Place a barbell in a rack just below shoulder-height. Dip under the bar to put it behind the neck across the top of the back, and grip the bar with the hands wider than shoulder-width apart. Lift the chest up and squeeze the shoulder blades together to keep the straight back throughout the entire movement. Stand up to bring the bar off the rack and step backwards, then place the feet so that they are a little wider than shoulder-width apart. Sit back into hips and keep the back straight and the chest up, squatting down so the hips are below the knees. From the bottom of the squat, press feet into the ground and push hips forward to return to the top of the standing position."));
